...
type DataService interface {
	...
	GetUsers(ctx context.Context, pagination lib.Pagination) ([]User, error)
	...
	GetSessions(ctx context.Context, pagination lib.Pagination) ([]Session, error)
	...
	GetAccounts(ctx context.Context, pagination lib.Pagination) ([]Account, error)
}
